...
if choice == "N" or choice == "n":
    accessToken = "Bearer " + input("Enter value of access token: ")
else:
	accessToken = "Bearer YWFhMDVmNzItMzJkYi00OTJhLTg3NDctZWY5YzgyNDgyMjAxNGM2MjFiOWItYTFh_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b"
...
rooms = r.json()["items"]
for room in rooms:
    print(f"Title: {room['title']}, Type: {room['type']}")
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "HKKzSalou5XrBKEr4MkEtfPhUvHSIDDW"
                               }
